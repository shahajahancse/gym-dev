    ...
    <table class="table" id="purchasePackages-table">
        ...
        <tbody>
            ...
            @foreach ($members as $key => $value)
                <tr>
                    <td>{{ ++$key }}</td>
                    <td>{{ $value->member_unique_id }}</td>
                    <td>{{ $value->mem_name .' '. $value->last_name }}</td>
                    <td>{{ $value->mem_type }}</td>
                    <td>{{ $value->mem_address }}</td>
                    <td>{{ $value->mem_cell }}</td>
                    ...
                    <td>
                        <div class='btn-group'>
                            ...
                            {!! Form::open(['route' => ['members.destroy', $value->id], 'method' => 'delete']) !!}
