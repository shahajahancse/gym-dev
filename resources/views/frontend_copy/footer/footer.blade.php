...
background-repeat: no-repeat; width:100%; background-position: center; background-size:cover;">
    <div class="inline-block lg:flex gap-8 justify-between">
        <div class="w-full lg:w-[30%] xl:w-[25%] text-center lg:text-start">
            ...
            <div class="ps-1">
                <p class="text-12 lg:text-14 xl:text-16 font-poppins leading-[20px] my-1 lg:my-3">Fitness Training Management System</p>
                <p class="text-10 lg:text-13 xl:text-15 font-poppins leading-[15px] lg:leading-[19px]">Fitness Training stands as the foremost provider of Fitness Training software solutions in Bangladesh, delivering unparalleled excellence in Fitness Training software and solutions tailored to meet the diverse needs of businesses, regardless of their size.</p>
    ...
    <div class="flex items-center justify-center gap-2 py-4">
        ...
        <p class="font-poppins text-10 lg:text-12 xl:text-14 leading-4">Fitness Training <?php echo date("Y"); ?>
