...
@section('title')
    Fitness Training | Terms and Conditions
@endsection
    ...
    <div class="px-4 lg:px-20 mt-7 lg:mt-14 relative">
        <div class="w-[90%] lg:w-[80%] mx-auto">
            <h1 class="text-[#01669B] text-22 lg:text-28 xl:text-32 font-poppins font-[700] leading-7 text-center">Terms and
                Conditions</h1>
            <p class="font-poppins text-15 lg:text-18 leading-7 mt-8">Welcome to Fitness Training! These terms and conditions
                ...
                Fitness Training if you do not agree to all the terms and conditions stated on this page.
            </p>
            <div>
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        ...
                        continue to use Fitness Training if you do not agree to all the terms and conditions stated on this page.
                    </p>
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        1.2 You must not use Fitness Training in any way that causes, or may cause, damage to the system or
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">2.1 To access certain features of Fitness Training,
                    ...
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">2.2 You are solely responsible for maintaining
                        ...
                        account.</p>
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">2.3 Fitness Training reserves the right to suspend
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        3.1 Fitness Training prioritizes data security and
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        4.1 All intellectual property rights in Fitness Training and its content, including but not limited to
                        text, graphics, logos, images, and software, are owned by or licensed to Fitness Training.</p>
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        4.2 You may not reproduce, modify, distribute, display, or create derivative works of any part of
                        Fitness Training without our prior written consent.
                    </p>
                </div>
                <h1 class="font-poppins text-20 lg:text-24 text-[#01669B] leading-7 mt-8 font-[500]">
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        5.1 Fitness Training shall not be liable for any direct, indirect, incidental, special, or consequential
                        damages arising out of or in any way connected with the use of Fitness Training.
                    </p>
                </div>
                <h1 class="font-poppins text-20 lg:text-24 text-[#01669B] leading-7 mt-8 font-[500]">
                ...
                <div class="ms-6">
                    <p class="font-poppins text-15 lg:text-18 leading-7 mt-2">
                        6.1 Fitness Training reserves the right to revise these terms and conditions at any time without prior
                        notice. By continuing to use Fitness Training after any revisions, you agree to be bound by the updated
